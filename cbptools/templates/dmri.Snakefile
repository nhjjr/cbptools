...
rule connectivity:
    input:
        ...
        bet_binary_mask = <cbptools['input_data:bet_binary_mask']>,
        xfm = <cbptools['input_data:xfm']>,
        inv_xfm = <cbptools['input_data:inv_xfm']>
    output: 'connectivity/connectivity_{participant_id}.npy'
    threads: 1
    resources: mem_mb=10000, io=5
    params:
        samples = <cbptools['input_data:samples']>,
        pca_transform = <cbptools['parameters:connectivity:pca_transform']>,
        dist_thresh = <cbptools['parameters:connectivity:dist_thresh']>,
        loop_check = <cbptools['parameters:connectivity:loop_check']>,
        c_thresh = <cbptools['parameters:connectivity:c_thresh']>,
        step_length = <cbptools['parameters:connectivity:step_length']>,
        n_samples = <cbptools['parameters:connectivity:n_samples']>,
        n_steps = <cbptools['parameters:connectivity:n_steps']>,
        correct_path_distribution = <cbptools['parameters:connectivity:correct_path_distribution']>,
        wait_for_file = <cbptools['parameters:connectivity:wait_for_file']>,
        cleanup_fsl = <cbptools['parameters:connectivity:cleanup_fsl']>,
        cubic_transform = <cbptools['parameters:connectivity:cubic_transform']>,
